...
public class T300301 extends TranBase {
	...
	public void doSecu( Context context ) throws SFException {
		...
		try {
			...
			// }
			SFUtil.setResDataValue( context, "ACCT_BAL", BizUtil.getCobankTranAmount( context, acctBal ) );// 人民币可用余额
			SFUtil.setResDataValue( context, "RMB_AVAIL_WITHDRAW_BAL", BizUtil.getCobankTranAmount( context, availBal ) );// 人民币可用余额
			SFUtil.setResDataValue( context, "RMB_TRU_BAL", BizUtil.getCobankTranAmount( context, truBal ) );// 人民币管理账号余额
