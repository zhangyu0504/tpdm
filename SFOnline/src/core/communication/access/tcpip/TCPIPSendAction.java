...
public class TCPIPSendAction extends HostAccessAction {
	...
	public String doExecute( Context context ) throws EMPException {
		...
		try {
			...
			String cTimeout = ParamCache.getValue2("COBANK", "CONNECT_TIMEOUT");//连接超时时间
			String sTimeout = ParamCache.getValue2("COBANK", "SOCKET_TIMEOUT");//通讯超时时间
