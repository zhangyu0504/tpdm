...
public class JNDIConnection implements Connection {
	...
	public JNDIConnection(DataSource dataSource, Connection connection) {
	...
	public void close() throws SQLException {
		...
		{
			//EMPLog.log(EMPConstance.EMP_TRANSACTION, EMPLog.INFO, 0, "Do release the transaction connection:" + this + " from data source: " + dataSource);
			//holder.releaseConnection();
			return;
		}

		EMPLog.log(EMPConstance.EMP_TRANSACTION, EMPLog.DEBUG, 0, "Do release the connection:" + this + " from data source: " + dataSource);
