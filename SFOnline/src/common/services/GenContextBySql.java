...
/**
* <b>功能描述：</b><br>
* 将FBSSqlDefine定义的输入输出自动组装生成Context。<br>
*  @version 1.0
*  @modifier 
*/
public class GenContextBySql extends EMPService {
	...
	public Context getContext(Context appContext, String sqlDefineName) {
		...
		if (SQLDefine.class.isAssignableFrom(aDef.getClass()))
		{
			SQLDefine sqlDefInfo = (SQLDefine) aDef;
